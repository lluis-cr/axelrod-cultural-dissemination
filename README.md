...
docs/               # Public supporting documentation
config/             # Parameters
...
are not presented here as completed experimental results. Internal planning
notes for later MSc stages are kept private and are not part of the public
research record for this repository.
